...
WEIGHTS_PATH = os.path.join(dir_path, 'vggish_audioset_weights_without_fc2.h5')
WEIGHTS_PATH_TOP = os.path.join(dir_path, 'vggish_audioset_weights.h5')


def VGGish(load_weights=True,
           weights='audioset',
           input_tensor=None,
           input_shape=None,
           out_dim=None,
